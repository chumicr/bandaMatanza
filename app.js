const NAV_ITEMS = [
  ...
  { label: 'Banda', href: '#banda', children: [['Curr\u00edculum', '#curriculum'], ['Director', '#director'], ['Junta directiva', '#junta-directiva']] },
